...
\includegraphics<4-5>[width=0.6\textwidth]{images/droneFireIndoor.png}
...
\onslide<5->
\vspace{1em}
\textbf{Localisation} in \textbf{various environments}
...
\onslide<7->
\vspace{1em}
\textbf{The goal of sensor fusion for state estimation is to recover $X$}
\end{frame}
...
\begin{frame}{Estimating the gyroscope bias}
  ...
  \item Alternative: non-linear minimization
    \[
    cost(B) = \argmin_X ||\Xi X - S||^2 \onslide<5->{\textcolor{blue}{+ \lambda \times |B|}}
    \]
