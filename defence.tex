...
\begin{frame}{Accelerometer bias}
  \begin{columns}[T]
    ...
    \begin{figure}[h!]
      \centering
      \resizebox{0.85\textwidth}{!}{\input{graph/deadReckoningGT}}
      \caption{Ground truth motion}
    \end{figure}
    \begin{figure}[h!]
      \centering
      \resizebox{0.85\textwidth}{!}{\input{graph/deadReckoningAccBias}}
...
\begin{frame}{Gyroscope bias}
  \begin{columns}[T]
    ...
    \begin{figure}[h!]
      \centering
      \resizebox{0.85\textwidth}{!}{\input{graph/deadReckoningGyroBias}}
...
\begin{frame}{Results}
  \begin{figure}[h!]
    \centering
    \resizebox{\textwidth}{!}{\input{graph/speed}}
