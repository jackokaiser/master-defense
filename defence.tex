...
\definecolor{myyellow}{RGB}{255, 211, 0}
...
\begin{frame}{Back to the title}
  \textcolor<4->{green}{Absolute scale velocity} \textcolor<3->{pink}{determination} combining \textcolor<2->{myyellow}{visual and inertial measurements} for micro aerial vehicles
