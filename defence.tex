...
\plain{Absolute scale from visual measurements}{How big is this building?\vspace{-2em}\begin{center}\includegraphics[width=\textwidth]{images/buildingDetour.png}\end{center}}
...
\plain{Absolute scale from visual measurements}{\vspace{-2em}\begin{center}\includegraphics[width=\textwidth]{images/buildingScale.jpg}\end{center}}
...
\begin{figure}
\includegraphics[width=0.6\textwidth{images/referenceInEnv.png}
\end{figure}
...
% \end{subfigure}
% \begin{subfigure}[b]{0.3\textwidth}
% \includegraphics{images/altitudeSensor.png}
% \end{subfigure}
% \end{figure}
\end{frame}
